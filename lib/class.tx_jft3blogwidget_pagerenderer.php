 ...
 */
class tx_jft3blogwidget_pagerenderer
{
	public $conf = array();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jft3blogwidget/lib/class.tx_jft3blogwidget_pagerenderer.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jft3blogwidget/lib/class.tx_jft3blogwidget_pagerenderer.php']);
}
